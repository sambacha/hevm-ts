...
describe("Add", () => {
  ...
  it("Test Add overflow", () => {
    const bytecode =
      "7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff600101";
    const executor: EVMExecutor = createExecutor(
      disassembler,
      bytecode,
      cfgCreator,
  ...
  it("Test Add overflow 2", () => {
    const bytecode =
      "7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff600201";
    const executor: EVMExecutor = createExecutor(
      disassembler,
      bytecode,
      cfgCreator,
  ...
  it("Test Add overflow 3", () => {
    const bytecode =
      "7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff8001";
    const executor: EVMExecutor = createExecutor(
      disassembler,
      bytecode,
      cfgCreator,
