...
describe("Push", () => {
  ...
  it("Test PUSH32", () => {
    const bytecode =
      "7fa12b7e68c7bbc4e1f6080c96a7461d449d27e98c31020e4229d8cd8b4942009a";
    const executor: EVMExecutor = createExecutor(
      disassembler,
      bytecode,
      cfgCreator,
    ...
    executor.run(0);
    const expectedWord1: Word = Word.createLiteral(
      "a12b7e68c7bbc4e1f6080c96a7461d449d27e98c31020e4229d8cd8b4942009a",
    );
    expect(executor.evm.stack.stack).toContainEqual(expectedWord1);
    expect(executor.evm.stack.length()).toEqual(1);
  });
