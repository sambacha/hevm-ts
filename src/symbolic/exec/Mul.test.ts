...
describe("Mul", () => {
  ...
  it("Test Mul overflow", () => {
    const bytecode =
      "7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff600202";
    const executor: EVMExecutor = createExecutor(
      disassembler,
      bytecode,
      cfgCreator,
  ...
  it("Test Mul overflow 2", () => {
    const bytecode =
      "7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff600302";
    const executor: EVMExecutor = createExecutor(
      disassembler,
      bytecode,
      cfgCreator,
  ...
  it("Test Mul overflow 3", () => {
    const bytecode =
      "7fffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff8002";
    const executor: EVMExecutor = createExecutor(
      disassembler,
      bytecode,
      cfgCreator,
